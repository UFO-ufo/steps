...
const TABS = [
  "Submit Steps", "Campus Average", "Campus Total Steps", "Highest Steps",
...
function CampusTotalSteps({ students }) {
  ...
  return (
    <div className="leaderboard-wrap">
      <h2 className="lb-title">🏫 Campus Total Steps</h2>
      <p style={{ color:"var(--muted)", fontSize:"0.8rem", marginBottom:"1.25rem", marginTop:"-0.75rem" }}>
        Combined steps from every submission at each campus.
      </p>
      ...
      <table className="lb-table">
        <thead>
          <tr><th>Rank</th><th>Campus</th><th>Total Steps</th><th>Students</th><th>Days Logged</th><th>% of Total</th></tr>
        </thead>
        <tbody>
          {rows.map((r, i) => (
            <tr key={r.campus} className={i<3?`top-${i+1}`:""}>
